...
android {
    namespace = "com.example.bankx_plore"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.bankx_plore"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Add material-icons-extended for icons like VisibilityOff
    ...
    implementation("com.google.firebase:firebase-analytics") // For analytics (optional)
}
